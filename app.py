...
if language == 'Français':
    ...
    with col1:
        ...
        if (prediction[0] >= 0 and prediction[0] < 5):
            ...
            st.markdown(
                'RECOMMANDATIONS: <span style="{}">Dormez sous Moustiquaires Impregnées . Assainissez votre cadre de vie et rendez vous immediatement au centre de santé en cas de fièvre. </span>'.format(
            ...
            st.markdown('Statut: <span style="{}">Modéré</span>'.format("color:orange;", word_style),
                        unsafe_allow_html=True)
            st.markdown(
                'RECOMMANDATIONS: <span style="{}">Dormez sous Moustiquaires Impregnées  . Fermez vos portes et fenêtres à partir de 17H . Assainissez votre cadre de vie . Rendez vous immediatement au centre de santé en cas de fièvre. </span>'.format(
                    "color:blue;", word_style),
                unsafe_allow_html=True)
            ...
            st.markdown('Statut: <span style="{}">Elevé</span>'.format("color:pink;", word_style),
                        unsafe_allow_html=True)
            st.markdown(
                'RECOMMANDATIONS: <span style="{}"> Dormez sous Moustiquaire Impregnées. Fermez vos portes et fenêtres à partir de 17H . Assainissez votre cadre de vie et rendez vous immediatement au centre de santé en cas de fièvre. </span>'.format(
                    "color:blue;", word_style),
                unsafe_allow_html=True)
        else:
        ...
        if auto_df.isnull().values.any():
            ...
            if (auto_prediction[0] >= 5 and auto_prediction[0] < 14.56):
                st.markdown('Statut: <span style="{}">Très Faible</span>'.format("color:green;", word_style),
                            unsafe_allow_html=True)
                st.markdown(
                    'RECOMMANDATIONS: <span style="{}">Dormez sous Moustiquaires Impregnées . Assainissez votre cadre de vie et rendez vous immediatement à au centre de santé en cas de fièvre. </span>'.format(
                        "color:blue;", word_style),
                    unsafe_allow_html=True)
                ...
                st.markdown('Statut: <span style="{}">Modéré</span>'.format("color:orange;", word_style),
                            unsafe_allow_html=True)
                st.markdown(
                    'RECOMMANDATIONS: <span style="{}">Dormez sous Moustiquaires Impregnées  . Fermez vos portes et fenêtres à partir de 17H . Assainissez votre cadre de vie et rendez vous immediatement au centre de santé en cas de fièvre. </span>'.format(
                        "color:blue;", word_style),
                    unsafe_allow_html=True)
    ...
    with col1:
        ...
        if (auto_prediction[0] >= 5 and auto_prediction[0] < 14.56):
            st.markdown('Statut: <span style="{}">Très Faible</span>'.format("color:green;", word_style),
                        unsafe_allow_html=True)
            st.markdown(
                'RECOMMANDATIONS: <span style="{}">Sleep under insecticide-treated mosquito nets. From 5 pm on, shut your windows and doors. Ensure that your living space is cleaner and seek immediate medical attention in the case of a fever. </span>'.format(
                    "color:blue;", word_style),
                unsafe_allow_html=True)
        elif (auto_prediction >= 14.56 and auto_prediction[0] < 19.14):
            st.markdown('Statut: <span style="{}">Faible</span>'.format("color:green;", word_style),
    ...
    if auto_df.isnull().values.any():
        ...
        if (auto_prediction[0] >= 0 and auto_prediction[0] < 5):
            st.markdown('Status: <span style="{}">Very low</span>'.format("color:blue;", word_style),
                        unsafe_allow_html=True)
            st.markdown(
                'RECOMMENDATIONS: <span style="{}">Sleep under insecticide-treated mosquito nets. From 5 pm on, shut your windows and doors. Ensure that your living space is cleaner and seek immediate medical attention in the case of a fever.</span>'.format(
                    "color:blue;", word_style),
                unsafe_allow_html=True)
